...
actor RouterRegistry is InFlightAckRequester
  ...
  =>
    ...
    _autoscale = Autoscale(_auth, this, _connections)
  ...
  be inform_contacted_worker_of_initialization() =>
    @printf[I32]("!@ inform_contacted_worker_of_initialization\n".cstring())
    _inform_contacted_worker_of_initialization()
  ...
  fun ref _inform_contacted_worker_of_initialization() =>
    ...
    | let cw: String =>
      ...
      then
        ...
        @printf[I32]("!@ Still waiting for listeners!\n".cstring())
  ...
  be remote_join_migration_request(new_workers: Array[String] val) =>
    """
    ...
    then
      _begin_join_migration(new_workers)
    end
  ...
  be initiate_join_migration(target_workers: Array[String] val) =>
    ...
    _begin_join_migration(target_workers)

  fun ref _begin_join_migration(target_workers: Array[String] val) =>
    """
